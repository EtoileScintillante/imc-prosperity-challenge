...
# In this file: no volcanic rock or vouchers yet!
# Just different logic for the other products
# This seems to work better than our previous used logic (in algov2_final.py)
# Code adapted from Team Linear Utility :-)
