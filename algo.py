...
# For vouchers: volatility arbitrage (hint from wiki)
# For VOLCANIC_ROCK: same strategy as SQUID_INK (with different params)
# Not the highest PnL for rock (300-500 PnL per day) in backtester, but never negative 
# Better to have something than nothing lol
...
PARAMS = {
    ...
    Product.VOLCANIC_ROCK: {
        ...
        "prevent_adverse": True,
        "adverse_volume": 85,
        "reversion_beta": -0.01135, # analysis.ipynb
        "disregard_edge": 1,
        "join_edge": 2,
        "default_edge": 1,
    ...
    Product.SPREAD1: {
        "default_spread_mean": 57.6585, # analysis.ipynb
        "default_spread_std": 83.7346,  # analysis.ipynb
        "spread_std_window": 45,
        "zscore_threshold": 7,
        "target_position": 58 
    },
    Product.SPREAD2: {
        "default_spread_mean": -4509.7247, # analysis.ipynb
        "default_spread_std": 97.2129,     # analysis.ipynb
        "spread_std_window": 45,
        "zscore_threshold": 7,
        "target_position": 98
    },
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        if Product.VOLCANIC_ROCK in self.params and Product.VOLCANIC_ROCK in state.order_depths:
            ...
            self.rock_history.append((best_bid + best_ask)/2)
            ...
            VOLCANIC_ROCK_make_orders, _, _ = self.make_orders(
                ...
                True,
                self.params[Product.VOLCANIC_ROCK]["soft_position_limit"],
            )
            result[Product.VOLCANIC_ROCK] = (
                VOLCANIC_ROCK_make_orders + VOLCANIC_ROCK_take_orders + VOLCANIC_ROCK_clear_orders
            )
        ...
        self.voucher_zscore_threshold = {
            Product.VOLCANIC_ROCK_VOUCHER_9500: 1.88,
            Product.VOLCANIC_ROCK_VOUCHER_9750: 1.36,
            Product.VOLCANIC_ROCK_VOUCHER_10000: 1.38,
            Product.VOLCANIC_ROCK_VOUCHER_10250: 1.5,
            Product.VOLCANIC_ROCK_VOUCHER_10500: 1.7,
        } # backtester pnl: 638,960
