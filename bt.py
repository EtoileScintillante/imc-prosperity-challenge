...
# From: https://github.com/ericcccsliu/imc-prosperity-2/tree/main
# Edited to work with 2025 products
...
class Backtester:
    def __init__(self, trader, listings: Dict[str, Listing], position_limit: Dict[str, int], fair_marks, 
        ...
        self.trade_history = trade_history.sort_values(by=['timestamp', 'product'])
